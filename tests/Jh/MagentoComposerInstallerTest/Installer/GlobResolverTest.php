...
namespace Jh\MagentoComposerInstallerTest\Installer;
 ...
 * @package Jh\MagentoComposerInstaller\Magento\InstallStrategyOld
...
class GlobResolverTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGlobsAreExpanded()
    {
        ...
        $this->assertContainsOnlyInstancesOf('Jh\MagentoComposerInstaller\Map\Map', $resolvedMappings);
