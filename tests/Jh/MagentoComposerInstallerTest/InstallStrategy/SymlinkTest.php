...
use Jh\MagentoComposerInstaller\InstallStrategy\Symlink;
...
class SymlinkTest extends AbstractStrategyTest
{
    public function setUp()
    {
        ...
        $this->assertInstanceOf(
            'Jh\MagentoComposerInstaller\InstallStrategy\InstallStrategyInterface',
    ...
    {
        $fileSystem = $this->getMock('Jh\MagentoComposerInstaller\Util\FileSystem');
    ...
    public function testIfDestinationDirectoryExistsAndIsSameBaseAsSourceExceptionIsThrownIfNotForce()
    {
        ...
        $this->setExpectedException(
            'Jh\MagentoComposerInstaller\InstallStrategy\Exception\TargetExistsException'
        );
