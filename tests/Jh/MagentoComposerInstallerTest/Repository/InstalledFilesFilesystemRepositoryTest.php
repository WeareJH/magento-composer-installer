...
namespace Jh\MagentoComposerInstallerTest\Repository;
 ...
 * @package Jh\MagentoComposerInstaller\Magento\Repository
...
class InstalledFilesFilesystemRepositoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetInstalledMappingsReturnsMappingsCorrectly()
    {
        ...
        $this->assertInstanceOf('Jh\MagentoComposerInstaller\Map\MapCollection', $package->getMappings());
        ...
        $this->assertInstanceOf('Jh\MagentoComposerInstaller\InstalledPackage', $package);
    }
